...
test("should render APPOINTMENT_READY if user has an active treatment and an appointment in the future", async () => {
  mockUser = {
    id: "123",
    email: "tom.brady@psi.com.br",
    role: "PATIENT",
  ...
  await waitFor(() => {
    screen.getByText(
      "Sua próxima consulta está confirmada para as 04:47 horas do dia 04/02/2021",
    ) as HTMLButtonElement;
  });
